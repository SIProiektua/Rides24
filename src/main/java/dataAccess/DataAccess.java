...
public class DataAccess  {
	...
	//Boolean b egitean registerren dago definituta zein user mota den hortaz errezten da jakiteko den driver edo Traveler, gero informazio guztia gordetzen da
