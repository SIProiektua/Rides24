...
Beste arazorik larriena hurrengokoa da: bookRides klasean informazioa ez zen gordetzen modu egokian datu basean zeren eta falta zitzaion bi cast egitea, hurrengoko GUI-an sartzeko zeren eta ez ziren bihurtzen Ride klasera gero PaymentGUI-n agertzeko bidair
3. Erabilpen kasu hedatuen eredua.
4. Domeinu eredu hedatua.
5. Diseinatutako erabilpen kasuen UML sekuentzia diagramak.
6. Diseinuzko klaseak
7. Inplementazioaren iturburu-kodea formatu elektronikoan.
